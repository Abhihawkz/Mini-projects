    ...
    <>
      ...
      <ul className="rules-list">
        <div className="rule-item">
          ...
          <p>Ensure your taking rest days when necessary</p>
        </div>
        <div className="rule-item">
          <p>
            <b> Reps </b>
      ...
      <h3>The Traning Plan</h3>
      <p>This training plan uses a structure know as the <b>Bro Split </b>, and follows this roatation</p>
      <p><b><i>Push &rarr; Pull &rarr; Legs &rarr; Repeat</i></b></p>
      <p>Complete all of the workours below and track your progress along the way</p>
    </>
  );
};
